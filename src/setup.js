...
const addPage = async (db, pageObject) => {
	...
	if (!docExists) {
		...
		console.log(`- Added page: /${pageObject.slug}`);
	}
};
...
const addOrderConfirmationEmailTemplates = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Order Confirmation');
	}
};
...
const addForgotPasswordEmailTemplates_en = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Password Reset English');
	}
};
...
const addForgotPasswordEmailTemplates_ru = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Password Reset Russian');
	}
};
...
const addForgotPasswordEmailTemplates_de = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Password Reset German');
	}
};
...
const addRegisterDoiEmailTemplates_en = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Account Activation English');
	}
};
...
const addRegisterDoiEmailTemplates_ru = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Account Activation Russian');
	}
};
...
const addRegisterDoiEmailTemplates_de = async db => {
	...
	if (emailTemplatesNotExists) {
		...
		console.log('- Added email template for Account Activation German');
	}
};
...
const addShippingMethods = async db => {
	...
	if (shippingMethodsNotExists) {
		...
		console.log('- Added shipping method');
	}
};
...
const createAllIndexes = async db => {
	...
	if (pagesIndexes.length === 1) {
		...
		console.log('- Created indexes for: pages');
	}
	...
	if (productCategoriesIndexes.length === 1) {
		...
		console.log('- Created indexes for: productCategories');
	}
...
const addUser = async (db, userEmail) => {
	if (userEmail && userEmail.includes('@')) {
		...
		if (tokensNotExists) {
			...
			console.log(`- Added token with email: ${userEmail}`);
		}
	}
};
