...
class SettingsRoute {
	constructor(router,databaseConnection) {
		this.router = router;
		SettingsService.db=databaseConnection;
		EmailSettingsService.db=databaseConnection;
		EmailTemplatesService.db=databaseConnection;
		CheckoutFieldsService.db=databaseConnection;
		this.registerRoutes();
	}
