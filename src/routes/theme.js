...
class ThemeRoute {
	constructor(router,databaseConnection) {
		this.router = router;
		this.registerRoutes();
		ThemeService.db=databaseConnection;
		ThemeSettingsService.db=databaseConnection;
		ThemeAssetsService.db=databaseConnection;
		ThemePlaceholdersService.db=databaseConnection;
	}
