...
class ProductsRoute {
	constructor(router,databaseConnection) {
		this.router = router;
		this.registerRoutes();
		ProductsService.db=databaseConnection;
		ProductOptionsService.db=databaseConnection;
		ProductOptionValuesService.db=databaseConnection;
		ProductVariantsService.db=databaseConnection;
		ProductImagesService.db=databaseConnection;
	}
