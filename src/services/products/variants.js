...
module.exports=function(){
	...
	function addVariant(productId, data) {
		if (!ObjectID.isValid(productId)) {
			return Promise.reject('Invalid identifier');
		}
		let productObjectID = new ObjectID(productId);
	...
	function updateVariant(productId, variantId, data) {
		if (!ObjectID.isValid(productId) || !ObjectID.isValid(variantId)) {
			return Promise.reject('Invalid identifier');
		}
		let productObjectID = new ObjectID(productId);
	...
	function getValidDocumentForInsert(data) {
		let variant = {
			id: new ObjectID(),
	...
	function getValidDocumentForUpdate(data) {
	...
	function getVariantOptions(productId, variantId) {
		let productObjectID = new ObjectID(productId);
	...
	function getModifiedVariantOptions(productId, variantId, optionId, valueId) {
	...
	function setVariantOption(productId, variantId, data) {
		if (
